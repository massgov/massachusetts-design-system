...
When using these tokens for your project, use only the index.css file (Semantic tokens). Never reference the primitives - the primitives may change depending on color theme so usingthem will not keep your styling up to date.
