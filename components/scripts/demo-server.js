...
const componentsRoot = packageRoot;
...
function getPort() {
  const rawPort = process.env.MDS_COMPONENTS_DEMO_PORT || process.env.PORT;
...
function openUrl(url) {
  ...
  if (result.error) {
    console.warn(`Unable to open components demo: ${result.error.message}`);
  }
}
